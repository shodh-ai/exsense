...
export enum ClientUIActionType {
  ...
  /** ADD_EXCALIDRAW_BLOCK - Excalidraw Block Management (for whiteboard/feed) */
  ADD_EXCALIDRAW_BLOCK = 201,
  /** UPDATE_EXCALIDRAW_BLOCK - Update elements/content of an existing Excalidraw block */
...
export function clientUIActionTypeFromJSON(object: any): ClientUIActionType {
  switch (object) {
    ...
    case 201:
    case "ADD_EXCALIDRAW_BLOCK":
      return ClientUIActionType.ADD_EXCALIDRAW_BLOCK;
    case 202:
    case "UPDATE_EXCALIDRAW_BLOCK":
      return ClientUIActionType.UPDATE_EXCALIDRAW_BLOCK;
    case 203:
    case "FOCUS_ON_BLOCK":
...
export function clientUIActionTypeToJSON(object: ClientUIActionType): string {
  switch (object) {
    ...
    case ClientUIActionType.ADD_EXCALIDRAW_BLOCK:
      return "ADD_EXCALIDRAW_BLOCK";
    case ClientUIActionType.UPDATE_EXCALIDRAW_BLOCK:
