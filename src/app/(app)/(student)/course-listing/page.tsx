...
const CoursesPage = (): JSX.Element => {
 ...
 const courses: Course[] = useMemo(() => {
   ...
   // --- MODIFICATION START ---
   // Filter courses to only include those with a 'PUBLISHED' status.
 ...
 <Input className="border-0 bg-transparent shadow-none w-full h-[48px] pl-5 pr-2 text-black placeholder:text-gray-400 placeholder:font-medium placeholder:text-sm placeholder:leading-normal focus:ring-0" placeholder="Search for anything..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
 ...
 {!isLoading && !error && courses.length === 0 && (
    <p className="text-center text-gray-500 col-span-full">No published courses available at the moment. Please check back later!</p>
 )}
