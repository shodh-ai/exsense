...
const plusJakartaSans = Plus_Jakarta_Sans({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"], // Added common weights including 500 (medium) and 600 (semibold)
...
const PasswordChanged = (): JSX.Element => {
  ...
  return (
    ...
    <div className={`flex min-h-full w-full items-center justify-center bg-transparent p-4 ${plusJakartaSans.className}`}>
      <Sphere />
      {/* 
