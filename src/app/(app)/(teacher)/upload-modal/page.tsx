          ...
          {showUploadCard && (
            <Card className="w-full max-w-[750px] rounded-[32px] border border-solid border-[#566fe980] shadow-[0px_6px_20px_#00000026] flex flex-col">
              <CardHeader className="p-4 sm:p-6">
                <CardTitle className="font-bold text-[#394169] text-[18px]  sm:text-[18px]">
                  Upload files
                </CardTitle>
              </CardHeader>
              
              <CardContent className="flex flex-col flex-grow p-4 pt-0 sm:px-8 sm:pb-8">
                ...
                <div className="flex-grow space-y-6">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    >
                      <div className="flex flex-col items-center gap-3 p-4">
                        <Image src="/UploadIcon.svg" alt="Upload Training File" width={40} height={40} />
                        <p className="font-paragraph-extra-large text-center text-[16px] sm:text-lg"><span className="text-[#394169] text-[16px]">Drop or </span><span className="text-[#566fe9] text-[16px]">Select</span><span className="text-[#394169] text-[16px]"> Training Files</span></p>
                        <p className="font-semibold font-weight-600 text-[#8781a0] text-[14px] text-center">File supported: {getExtensionList(TRAINING_FILE_MIMES)}</p>
                    ...
                    >
                      <div className="flex flex-col items-center gap-3 p-4">
                        <Image src="/studentfiles.svg" alt="Upload Student Video" width={40} height={40} />
                        <p className="font-paragraph-extra-large text-center text-[16px] sm:text-lg"><span className="text-[#394169] text-[16px]">Drop or </span><span className="text-[#566fe9] text-[16px]">Select</span><span className="text-[#394169] text-[16px]"> Student Videos</span></p>
                        <p className="font-semibold font-weight-600 text-[#878787] text-[14px] text-center">File supported: {getExtensionList(STUDENT_VIDEO_MIMES)}</p>
                  ...
                  <div className="flex flex-col sm:flex-row sm:h-[50px] items-center gap-1 p-1 bg-white rounded-[36px] border border-solid border-[#566fe94c]">
                    <Tabs defaultValue="links" className="w-auto" onValueChange={(value: string) => setActiveInputTab(value as "links" | "paste")}>
                      {/* 
                        FIX: Removed grid layout from the parent. The parent now just wraps the two fixed-width tabs.
                      */}
                      <TabsList className="h-[42px] p-0 bg-transparent">
                        {/* 
                          FIX: Added `w-[130px]` for a fixed width and `flex justify-center` to center the content inside.
                        */}
                        <TabsTrigger value="links" className="w-[130px] h-[42px] flex items-center justify-center data-[state=active]:bg-[#566fe91a] data-[state=active]:text-[#566fe9] data-[state=inactive]:bg-transparent data-[state=inactive]:text-[#566fe9] data-[state=inactive]:opacity-80 rounded-[40px]">
                          <img src="/Link.svg" className="w-5 h-5 mr-2" alt="Links" />Links
                        </TabsTrigger>
                        {/* 
                          FIX: Added `w-[130px]` for a fixed width and `flex justify-center` to center the content inside.
                        */}
                        <TabsTrigger value="paste" className="w-[130px] h-[42px] flex items-center justify-center data-[state=active]:bg-[#566fe91a] data-[state=active]:text-[#566fe9] data-[state=inactive]:bg-transparent data-[state=inactive]:text-[#566fe9] data-[state=inactive]:opacity-80 rounded-[40px]">
                          <img src="/paste.svg" className="w-5 h-5 mr-2" alt="Paste text" />Paste text
                        </TabsTrigger>
                      </TabsList>
                    </Tabs>
